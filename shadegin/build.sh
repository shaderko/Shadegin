...
gcc -Wall -g -I /Users/filiplukovic/Documents/projects/shadegin/include $files $libs -o mygame `sdl2-config --cflags --libs` `pkg-config --libs cglm`
