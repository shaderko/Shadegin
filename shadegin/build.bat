...
set networking=src/engine/networking/server.c src/engine/networking/room.c src/engine/networking/client.c
set files=src\glad.c src\main.c src\engine\global.c src\engine\util.c nanosleep.c %render% %physics% %scene% %io% %game_files% %networking%
set scene=src/engine/game_objects/map/scene.c
